    ...
    render(){
        if(this.state.loading){
            ...
            for(let i=0; i<this.tracksData.length; i++){
                ...
                trackElements.push(<Track idx={i+1} artist={trackData.artists[0].name} trackName={trackData.name} valence={this.valenceData[i]}/>)
            }
            return (
                <div className="wrapper">
                    <h2>Your mood is</h2>
                    <Emoticon valence={this.state.avgValence} size={100}/>
                    <div id="tracks">
